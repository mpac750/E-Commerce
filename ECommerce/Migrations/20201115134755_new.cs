    ...
    public partial class @new : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaTH = table.Column<string>(type: "nvarchar(450)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaNhaCC = table.Column<int>(type: "int", nullable: false),
                    LoaiMaLoai = table.Column<int>(type: "int", nullable: true),
                    ThuongHieuMaTH = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    NhaCungCapMaNhaCC = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Khos", x => x.MaSP);
                    table.ForeignKey(
                        name: "FK_Khos_Loais_LoaiMaLoai",
                        column: x => x.LoaiMaLoai,
                        principalTable: "Loais",
                        principalColumn: "MaLoai",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Khos_NhaCungCaps_NhaCungCapMaNhaCC",
                        column: x => x.NhaCungCapMaNhaCC,
                        principalTable: "NhaCungCaps",
                        principalColumn: "MaNhaCC",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Khos_ThuongHieus_ThuongHieuMaTH",
                        column: x => x.ThuongHieuMaTH,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    KhoMaSP = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Khos_LoaiMaLoai",
                table: "Khos",
                column: "LoaiMaLoai");

            migrationBuilder.CreateIndex(
                name: "IX_Khos_NhaCungCapMaNhaCC",
                table: "Khos",
                column: "NhaCungCapMaNhaCC");

            migrationBuilder.CreateIndex(
                name: "IX_Khos_ThuongHieuMaTH",
                table: "Khos",
                column: "ThuongHieuMaTH");
